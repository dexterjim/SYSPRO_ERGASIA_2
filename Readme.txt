...
(Τα παραπάνω παραδείγματα είναι για να δωθουν στον αρχικό φάκελο)
...
A) mirror_client :
	...
	-functions.c :
		...
		λάθους αλλίως τον δημιουργεί και τέλος φτιάχνει το common_dir.
	...
	-list.c :
		...
		στοιχείο στο τέλος της λίστας , και αν αυτό είναι NULL , δίνω τιμή και στο start
		πεδίο , το still_exist το κάνω 1 καθώς μόλις το διάβασα και προφανώς υπάρχει.
		...
		επιστρέφω το όνομα,αλλίως NULL.
